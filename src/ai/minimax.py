...
class MinimaxGroup10:
    ...
    def __minimax(self, state : State, depth : int, alpha : int, beta : int, maximizing : bool):
        if depth == 0:
        ...
        if maximizing:
            ...
            for column in range(state.board.col):
                for shapes in ListShape:
                    ...
                    if ret_code != -1:
                        new_score = self.__minimax(new_state, depth-1, alpha, beta, False)[1]
                        if new_score > value:
                            value = new_score
                            col   = column
                            shape = shapes
        ...
        # Minimizer
            ...
            for column in range(state.board.col):
                for shapes in ListShape:
                    ...
                    if ret_code != -1:
                        new_score = self.__minimax(new_state, depth-1, alpha, beta, True)[1]
                        if new_score < value:
                            value = new_score
                            col   = column
                            shape = shapes
    ...
    def find(self, state: State, n_player: int, thinking_time: float) -> Tuple[str, str]:
        ...
        best_movement = self.__minimax(state, 4, -inf, inf, is_maximizer)[0]
